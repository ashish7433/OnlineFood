...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper" style="background-color:#778da9">
     ...
     <div class="header">
         ...
         <div class="navbar-header">
                 <a class="navbar-brand" href="dashboard.php">
                     ...
                     <span><img src="images/FluxMENUMASTER.jpeg" alt="homepage" class="dark-logo" style="width:400px; height:100px;"   /></span>
                 </a>
             </div>
     ...
     <div class="left-sidebar"style="background-color:#1B263B">

         <div class="scroll-sidebar" style="background-color:#1B263B" >
    
             <nav class="sidebar-nav">
                 <ul id="sidebarnav">
                     <li class="nav-devider"></li>
                     <li class="nav-label">Home</li>
                     <li> <span><a href="dashboard.php">Dashboard</a></span>
                     </li>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid" style="background-color:#778da9">
            ...
            <footer class="footer"> © 2025 - Order Your food</footer>
