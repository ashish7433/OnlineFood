...
if (empty($_SESSION["user_id"])) {
    ...
    if ($_POST['submit']) {
        ...
        // Set session variables for prefill
        $_SESSION["user_name"] = "John Doe"; // Replace with actual user name
        $_SESSION["user_email"] = "john@example.com"; // Replace with actual user email
        $_SESSION["user_phone"] = "1234567890"; // Replace with actual user phone number

        if ($payment_method == 'COD') {
            // Handle Cash on Delivery
            foreach ($_SESSION["cart_item"] as $item) {
                $SQL = "INSERT INTO users_orders(u_id, title, quantity, price, payment_method) VALUES ('" . $_SESSION["user_id"] . "', '" . $item["title"] . "', '" . $item["quantity"] . "', '" . $item["price"] . "', 'COD')";
                mysqli_query($db, $SQL);
            }
            ...
            <div class="container m-t-30">
                <form action="" method="post">
                    <div class="widget clearfix">
                        <div class="widget-body" style="background-color:#cce3de;">
                            <div class="row">
                                <div class="col-sm-12">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li>
                                                <label class="custom-control custom-radio m-b-10">
                                                    <input name="mod" id="radioStacked2" value="razorpay" type="radio" class="custom-control-input">
                                                    <span class="custom-control-indicator"></span>
                                                    <span class="custom-control-description">Razorpay <img src="images/razorpay.png" alt="" width="90"></span>
                                                </label>
                                            </li>
                                        </ul>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xs-12 col-sm-3 payment-options color-gray">
                                ...
                                <ul>
                                    <li><a href="#"><img src="images/razorpay.png" alt="Razorpay"></a></li>
