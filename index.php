														...
														<div class="restaurant-wrap">
															<div class="row">
																<div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
																	<a class="restaurant-logo" href="dishes.php?res_id='.$rows['rs_id'].'" > <img src="admin/Res_img/'.$rows['image'].'" alt="Canteen logo"> </a>
																</div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Sai Kutir Co op Chs, Viva jangid Complex, Manvelpada, Near Mohak city, Virar east, Maharashtra, 401305.</p>
                                    <h5>Phone: 000000000</a></h5> </div>
                                    </p>
                                    <h5>Mr.Adarsh</a></h5> </div>
